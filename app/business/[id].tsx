        ...
        >
          ...
          <View style={styles.heroBottom}>
            <View style={styles.heroIconWrap}>
              <Ionicons name={business.icon as any} size={36} color={colors.textInverse} />
            </View>
            <View style={styles.heroNameRow}>
              <Text style={[styles.heroTitle, { color: colors.textInverse }]}>{business.name}</Text>
              {business.isVerified && (
              ...
              {business.isIndigenousOwned && (
                <View style={[styles.verifiedBadge, { backgroundColor: 'rgba(139,69,19,0.8)' }]}>
                  <Ionicons name="earth" size={16} color={colors.textInverse} />
